...
export default function PricingComponentDropDown() {
    ...
    <div>
      <Button
        ...
        sx={{
          ...
          padding: '3px 12px', // Padding to match the button size
      ...
      <StyledMenu
        ...
        onClose={handleClose}
      >
        <MenuItem onClick={handleClose} disableRipple sx={{ fontSize: '0.9rem' }}>
        Pricing Component
        </MenuItem>
      </StyledMenu>
    </div>
