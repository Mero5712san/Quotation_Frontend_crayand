...
const Remove   = ({ opencondition, setopencondition, id }) => {
                                ...
                                <div className="first">
                                    ...
                                    <div className="infos">
                                        <div className="nameinfo">
                                            ...
                                            <div className="version">UNIT-{unitDetails.unit_id || "N/A"}</div>
                                        </div>
                                ...
                                <div className="second">
                                    <div className="upper">
                                        ...
                                        <div className="element">
                                            ...
                                            <li className="amount">$1000 <span><img src={del} alt="" /></span></li>
                                        </div>
                                        <div className="line"> </div>
                                        <div className="element">
                                            <li>bill name here</li>
